...
<!-- badges: end -->
<p align = "justify">
We introduce STew, a <strong>S</strong>patial <strong>T</strong>ranscriptomic multi-vi<strong>EW</strong> representation learning method, or STew, to jointly characterize the gene expression variation and spatial information in the shared low-dimenion space in a scalable manner. STew will output distinct spatially informed cell gradients, robust clusters, and statistical goodness of model fit to reveal significant genes that reflect subtle spatial niches in complex tissues.
</p>
...
- <a href="https://htmlpreview.github.io/?https://github.com/fanzhanglab/STew/blob/main/vignettes/Tutorial_STew_DLPFC.html"> Tutorial of applying STew on DLPFC data </a>
- <a href = 'https://htmlpreview.github.io/?https://github.com/fanzhanglab/STew/blob/main/vignettes/count_modeling_tutorial_dlpfc.html'> Tutorial of count data modelling </a>
